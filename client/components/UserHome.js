      ...
      <table className="striped" >
         ...
         <tbody>
         {
            ...
            <tr key={stock.symbol}>
             ...
             <td className='center-align'><button data-target="modal1" onClick={() => this.handleClick(stock.askPrice, stock.symbol, "SEll")} className="btn btn-small waves-effect waves-light" name="sell-button">Sell</button></td>
